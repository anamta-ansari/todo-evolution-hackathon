...
def test_signup_and_signin():
    ...
    try:
        ...
        if response.status_code == 201:
            ...
            print("   WARNING: User already exists (this is OK for testing)")
        ...
        print(f"   ERROR: Cannot connect to server at {BASE_URL}. Please make sure the server is running.")
        return False
    except Exception as e:
        print(f"   ERROR: Error during signup: {str(e)}")
        return False
    ...
    try:
        ...
        print(f"   ERROR: Error during signin: {str(e)}")
        return False
    ...
    try:
        ...
        if response.status_code == 200:
            print("   SUCCESS: PROTECTED ENDPOINT ACCESS WORKED!")
        ...
        print(f"   ERROR: Error accessing protected endpoint: {str(e)}")
        return False
...
if __name__ == "__main__":
    ...
    if not success:
        ...
        print("\nSUCCESS: Authentication verification completed successfully.")